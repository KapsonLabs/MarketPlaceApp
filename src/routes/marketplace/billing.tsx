...
import { listUserBilling, recordPayment } from "@/lib/marketplace/requests.functions";
import type { BillingRecord, BillingStatus } from "@/lib/marketplace/billing";
import { Button } from "@/components/ui/button";
import { Card, CardContent } from "@/components/ui/card";
import { Badge } from "@/components/ui/badge";

export const Route = createFileRoute("/marketplace/billing")({
  head: () => ({
    meta: [
