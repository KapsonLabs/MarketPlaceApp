...
import { listReviewsForProvider } from "@/lib/marketplace/requests.functions";
import type { RequestReview } from "@/lib/marketplace/request-types";

export const Route = createFileRoute("/marketplace/providers/$providerId")({
  loader: async ({ params }) => {
  ...
  notFoundComponent: () => (
    <div className="container mx-auto px-4 py-20 text-center">
      ...
      <Button asChild className="mt-4">
        <Link to="/marketplace/providers">Back to providers</Link>
      </Button>
    </div>
  ),
